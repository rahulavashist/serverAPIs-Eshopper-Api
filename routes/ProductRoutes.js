...
router.post("/", upload.fields([
    ...
    try {
        ...
        data.finalprice = parseInt(parseInt(req.body.baseprice) - parseInt(req.body.baseprice) * parseInt(req.body.discount) / 100)
        if (req.files.pic1)
...
router.put("/:_id", upload.fields([
    ...
    try {
        ...
        if (data) {
            ...
            data.finalprice = Math.round(parseInt(parseInt(data.baseprice) - parseInt(data.baseprice) * parseInt(req.body.discount) / 100))
